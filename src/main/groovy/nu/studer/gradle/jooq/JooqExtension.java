...
public class JooqExtension {
    ...
    public JooqExtension(ObjectFactory objects) {
        ...
        this.versionIsProvidedByPlatform = objects.property(Boolean.class).convention(Boolean.FALSE);
    ...
    @SuppressWarnings("unused")
    public Property<Boolean> getVersionIsProvidedByPlatform() {
        return versionIsProvidedByPlatform;
    }
